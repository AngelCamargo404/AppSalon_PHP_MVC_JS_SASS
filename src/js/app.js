...
function seleccionarServicio(servicio) {
    ...
    if( servicios.some( agregado => agregado.id === id /* ID SERVICIOS */  ) ) {
        // Eliminarlo
...
function mostrarResumen() {
    ...
    const dia = fechaObj.getDate() + 2; // POR LAS VECES QUE SE DESFAZA EL DIA POR HABERLO LLAMADO
...
async function reservarCita() {
    ...
    // console.log([...datos]); // VER INFORMACIÓN ANTES DE PASARLA
